  ...
  return (
    <section id='home'
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <p className='font-montserrat text-slate-gray texl-lg leading-8 mb-14 mt-6 sm:max-w-sm'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aperiam cumque, laborum deserunt accusantium perspiciatis sint?</p>
      ...
      {/* <div className='relative flex-1 justify-center items-center xl:min-h-screen max-xl: py-40 bg-primary bg-hero bg-cover bg-center'>
        ...
        <div>
         {shoes.map((shoe, index) => (
          <div key={shoe} className='flex sm:gap-6
